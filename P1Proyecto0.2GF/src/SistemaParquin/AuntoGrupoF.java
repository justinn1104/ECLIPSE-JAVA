...
public class AuntoGrupoF {

}*/
package SistemaParquin;
/*
 * librerias y dependencias de uso
 * */
...
public class AutoGrupoF extends ParqueaderoGrupoF {
	...
	public AutoGrupoF(String tipoVeiculo, String fechaHora, String espacioSelecc, String numPlaca, String nombreUser, String telefono, String direccion) {
	...
	public void GenerarTiket() {
		...
		modelo = cin.nextLine();
		setModelo(modelo);
		System.out.print("INGRESA EL NUMERO DE LA PLACA DEL AUTOMOVIL [CARACTER. 7]: ");
		numPlaca = cin.nextLine();
		while(numPlaca.length()!=7) {
			System.out.print("**VUELVA A INGRESAR EL NUMERO DE LA PLACA DEL AUTOMOVIL [CARACTER. 7]**: ");
			numPlaca = cin.nextLine();
		}
